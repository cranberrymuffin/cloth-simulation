    ...
    m_height(height)
{
   ...
   // ErrorChecker::printGLErrors("FBO::23");
    glGenFramebuffers(1,&m_handle);

    // TODO [Task 3]
    // Call bind() and fill it in with glBindFramebuffer
    bind();
   // ErrorChecker::printGLErrors("FBO::28");
